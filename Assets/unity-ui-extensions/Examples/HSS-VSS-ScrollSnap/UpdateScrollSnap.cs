namespace UnityEngine.UI.Extensions.Examples
{
    public class UpdateScrollSnap : MonoBehaviour
    {
        ...
        {
            global::Logger.Log("Scroll Snap change started");
        }
        public void SelectionEndChange()
        {
            global::Logger.Log("Scroll Snap change finished");
        }
        public void PageChange(int page)
        {
            global::Logger.Log(string.Format("Scroll Snap page changed to {0}", page));
        }
