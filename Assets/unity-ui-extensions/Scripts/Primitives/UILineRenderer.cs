    ...
    public class UILineRenderer : UIPrimitiveBase
	{
		...
		private void PopulateMesh(VertexHelper vh, Vector2[] pointsToDraw)
		{
			...
			if (vh.currentVertCount > 64000) {
				//global::Logger.LogError ("Max Verticies size is 64000, current mesh vertcies count is [" + vh.currentVertCount + "] - Cannot Draw");
				vh.Clear ();
				return;
			}
		...
		private UIVertex[] CreateLineCap(Vector2 start, Vector2 end, SegmentType type)
		{
			...
			//global::Logger.LogError("Bad SegmentType passed in to CreateLineCap. Must be SegmentType.Start or SegmentType.End");
			return null;
		}
