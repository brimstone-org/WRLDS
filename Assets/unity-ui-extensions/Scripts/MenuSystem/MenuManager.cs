...
namespace UnityEngine.UI.Extensions
{
    ...
    public class MenuManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                //global::Logger.LogError("Not enough Menu Screens configured");
            }
        }
        ...
        public void CloseMenu(Menu menu)
        {
            if (menuStack.Count == 0)
            {
                //global::Logger.LogErrorFormat(menu, "{0} cannot be closed because menu stack is empty", menu.GetType());
                return;
            }

            if (menuStack.Peek() != menu)
            {
                //global::Logger.LogErrorFormat(menu, "{0} cannot be closed because it is not on top of stack", menu.GetType());
                return;
            }
