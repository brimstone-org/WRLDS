...
namespace UnityEngine.UI.Extensions.ColorPicker
{
	public class ColorPickerPresets : MonoBehaviour
	{
		...
		public virtual void SavePresets(SaveType saveType)
		{
			...
			{
				//global::Logger.LogError("presets cannot be null or empty: " + (presets == null ? "NULL" : "EMPTY"));
				return;
			}
			...
			{
				case SaveType.None:
					//global::Logger.LogWarning("Called SavePresets with SaveType = None...");
					break;
				case SaveType.PlayerPrefs:
		...
		protected virtual void HSVChanged(float h, float s, float v)
		{
			...
			//global::Logger.Log("hsv util color: " + createPresetImage.color);
		}

		protected virtual void ColorChanged(Color color)
		{
			createPresetImage.color = color;
			//global::Logger.Log("color changed: " + color);
		}
	}
}