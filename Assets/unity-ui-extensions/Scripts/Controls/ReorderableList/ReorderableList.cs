...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableList : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                //global::Logger.LogError("You need to have a child LayoutGroup content set for the list: " + name, gameObject);
                return;
            }
            ...
            {
                //global::Logger.LogError("You need to have a Graphic control (such as an Image) for the list [" + name + "] to be droppable", gameObject);
                return;
            }
        ...
        {
            global::Logger.Log("Event Received");
            global::Logger.Log("Hello World, is my item a clone? [" + item.IsAClone + "]");
        }
