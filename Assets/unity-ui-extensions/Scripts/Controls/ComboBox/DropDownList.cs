	...
	public class DropDownList : MonoBehaviour
	{
		...
		private bool Initialize()
		{
			...
			catch (System.NullReferenceException ex)
			{
				...
				//global::Logger.LogError("Something is setup incorrectly with the dropdownlist component causing a Null Reference Exception");
				success = false;
			}
		...
		*/
		...
		{
			//global::Logger.Log("item " + indx + " clicked");
