...
namespace UnityEngine.UI.Extensions
{
    ...
    public class AutoCompleteComboBox : MonoBehaviour
    {
        ...
        private bool Initialize()
        {
            ...
            {
                //global::Logger.LogException(ex);
                //global::Logger.LogError("Something is setup incorrectly with the dropdownlist component causing a Null Refernece Exception");
                success = false;
            }
        ...
        */
        ...
        {
            //global::Logger.Log("item " + item + " clicked");
            Text = item;
        ...
        public void OnValueChanged(string currText)
        {
            ...
            PruneItems(currText);
            RedrawPanel();
            //global::Logger.Log("value changed to: " + currText);
