    ...
    public class UI_InfiniteScroll : MonoBehaviour
    {
        ...
        public void Init()
        {
            if (GetComponent<ScrollRect>() != null)
            {
                ...
                {
                    //global::Logger.LogError("UI_InfiniteScroll doesn't support scrolling in both directions, plase choose one direction (horizontal or vertical)");
                }
            ...
            {
                //global::Logger.LogError("UI_InfiniteScroll => No ScrollRect component found");
            }
        }
