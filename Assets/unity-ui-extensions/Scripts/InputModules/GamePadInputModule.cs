...
namespace UnityEngine.EventSystems
{
    ...
    public class GamePadInputModule : BaseInputModule
    {
        ...
        public override void ActivateModule()
        {
            ...
            {
                //global::Logger.LogError("StandAloneInputSystem should not be used with the GamePadInputModule, " + "please remove it from the Event System in this scene or disable it when this module is in use");
            }
