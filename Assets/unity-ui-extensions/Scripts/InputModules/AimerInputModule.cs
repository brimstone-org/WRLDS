...
namespace UnityEngine.EventSystems.Extensions
{
    ...
    public class AimerInputModule : PointerInputModule
    {
        ...
        public override void ActivateModule()
        {
            ...
            {
                //global::Logger.LogError("Aimer Input Module is incompatible with the StandAloneInputSystem, " + "please remove it from the Event System in this scene or disable it when this module is in use");
            }
        }
        ...
        private void ProcessInteraction(PointerEventData pointer, bool pressed, bool released)
        {
            ...
            if (released)
            {
                //global::Logger.Log("Executing pressup on: " + pointer.pointerPress);
                ExecuteEvents.Execute(pointer.pointerPress, pointer, ExecuteEvents.pointerUpHandler);

                //global::Logger.Log("KeyCode: " + pointer.eventData.keyCode);
