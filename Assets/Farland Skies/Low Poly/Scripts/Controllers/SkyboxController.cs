...
namespace Borodar.FarlandSkies.LowPoly
{
    ...
    public class SkyboxController : Singleton<SkyboxController>
    {
        ...
        private void UpdateSkyboxProperties()
        {
            ...
            {
                //global::Logger.LogWarning("SkyboxController: Skybox material is not assigned.");
                return;
            }            
            ...
            if (_sunEnabled)
            {
                ...
                {
                    //global::Logger.LogWarning("SkyboxController: Sun light object is not assigned.");
                }                    
            ...
            if (_moonEnabled)
            {
                ...
                {
                    //global::Logger.LogWarning("SkyboxController: Moon light object is not assigned.");
                }
