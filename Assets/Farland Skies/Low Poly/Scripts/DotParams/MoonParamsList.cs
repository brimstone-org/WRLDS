...
{
    public class MoonParamsList : DotParamsList<MoonParam>
    {
        //---------------------------------------------------------------------
        // Ctors
        //---------------------------------------------------------------------

        public MoonParamsList(int capacity) : base(capacity) { }

        //---------------------------------------------------------------------
        // Public
        //---------------------------------------------------------------------

        public MoonParam GetParamPerTime(float currentTime)
        {
            if (Count <= 0)
            {
                //global::Logger.LogWarning("Moon params list is empty");
                Add(0, new MoonParam());
            }
            ...
            var currentParam = new MoonParam()
            {
