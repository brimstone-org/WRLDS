...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        public bool CheckForObstacle(float forwardDistance)
        {
            ...
            global::Logger.DrawLine(castingPosition, castingPosition + Vector3.down * (m_LocalBounds.extents.y + 0.2f));
        ...
        public void ScanForPlayer()
        {
            ...
            Vector3 dir = GameManager.Instance.PlayerPrefab.transform.position - transform.position;
            ...
            m_Target = GameManager.Instance.PlayerPrefab.transform;
            m_TimeSinceLastTargetView = timeBeforeTargetLost;
            global::Logger.Log("seen player");
