...
namespace Gamekit2D
{
    ...
    public class TransitionPoint : MonoBehaviour
    {
        ...
        //[NonSerialized]
        public float OriginalScreenY, OriginalScreenX;
        ...
        {
            if (other.gameObject == transitioningGameObject  && !other.isTrigger)
            {
                m_TransitioningGameObjectPresent = true;
...
//                return;
        ...
        {
            if (resetInputValuesOnTransition)
            {
                ...
                if (isExit)
                {
                    ...
                    LevelBuilder.Instance.CamSetup.GetCinemachineComponent<CinemachineFramingTransposer>().m_ScreenY = OriginalScreenY;
                    LevelBuilder.Instance.CamSetup.GetCinemachineComponent<CinemachineFramingTransposer>().m_ScreenX = OriginalScreenX;
                }
