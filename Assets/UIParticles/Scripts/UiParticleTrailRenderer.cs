    ...
    public class UiParticleTrailRenderer : MaskableGraphic
    {
        ...
        private void Start()
        {
            ...
            if (parent != null)
            {
                ...
                {
                    //global::Logger.LogError("UiParticleTrailRenderer doesn't contains UiParticles in parent object");
                    enabled = false;
                    return;
                }
            ...
            {
                //global::Logger.LogError("UiParticleTrailRenderer doesn't contains parent object");
                return;
            }
