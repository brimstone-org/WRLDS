...
public class UploadDownloadTexture : MonoBehaviour 
{
	...
	void Start () 
	{
		if(mode == Mode.Upload)
		{
			...
			if(texture == null){
				//global::Logger.LogError ("There is no texture attached to this object.");
			}
			else
	...
	private IEnumerator Upload(Texture2D texture)
	{
	    ...
	    if(web.isError){
	        //global::Logger.LogError(web.errorCode + ":" + web.error);
	    }
		else{
			global::Logger.Log ("Uploaded Successfully. Reload scene to load texture into blank object.");
	    }
	}
	...
	private IEnumerator Download()
	{
		...
		global::Logger.Log ("Texture successfully downloaded and applied to blank object.");
	}
	...
	private void SetTexture(Texture2D texture)
	{
	    ...
	    {
	        //global::Logger.LogError ("There is no material attached to this object.");
	    }
	}
}
