    ...
    public class ComparePropertyValue : Conditional
    {
        ...
        public override TaskStatus OnUpdate()
        {
            if (compareValue == null) {
                //global::Logger.LogWarning("Unable to compare field - compare value is null");
                return TaskStatus.Failure;
            }
            
            var type = TaskUtility.GetTypeWithinAssembly(componentName.Value);
            if (type == null) {
                //global::Logger.LogWarning("Unable to compare property - type is null");
                return TaskStatus.Failure;
            }

            var component = GetDefaultGameObject(targetGameObject.Value).GetComponent(type);
            if (component == null) {
                //global::Logger.LogWarning("Unable to compare the property with component " + componentName.Value);
                return TaskStatus.Failure;
            }
