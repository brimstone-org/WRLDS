...
namespace BehaviorDesigner.Runtime.Tasks
{
    ...
    public class InvokeMethod : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (type == null) {
                //global::Logger.LogWarning("Unable to invoke - type is null");
                return TaskStatus.Failure;
            }

            var component = GetDefaultGameObject(targetGameObject.Value).GetComponent(type);
            if (component == null) {
                //global::Logger.LogWarning("Unable to invoke method with component " + componentName.Value);
                return TaskStatus.Failure;
            }
            ...
            if (methodInfo == null) {
                //global::Logger.LogWarning("Unable to invoke method " + methodName.Value + " on component " + componentName.Value);
                return TaskStatus.Failure;
            }
