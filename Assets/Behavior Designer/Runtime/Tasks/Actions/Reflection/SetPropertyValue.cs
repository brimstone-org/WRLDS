    ...
    public class SetPropertyValue : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            if (propertyValue == null) {
                //global::Logger.LogWarning("Unable to get field - field value is null");
                return TaskStatus.Failure;
            }
            
            var type = TaskUtility.GetTypeWithinAssembly(componentName.Value);
            if (type == null) {
                //global::Logger.LogWarning("Unable to set property - type is null");
                return TaskStatus.Failure;
            }

            var component = GetDefaultGameObject(targetGameObject.Value).GetComponent(type);
            if (component == null) {
                //global::Logger.LogWarning("Unable to set the property with component " + componentName.Value);
                return TaskStatus.Failure;
            }
