    ...
    public class GetPropertyValue : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            if (propertyValue == null) {
                //global::Logger.LogWarning("Unable to get property - property value is null");
                return TaskStatus.Failure;
            }
            
            var type = TaskUtility.GetTypeWithinAssembly(componentName.Value);
            if (type == null) {
                //global::Logger.LogWarning("Unable to get property - type is null");
                return TaskStatus.Failure;
            }

            var component = GetDefaultGameObject(targetGameObject.Value).GetComponent(type);
            if (component == null) {
                //global::Logger.LogWarning("Unable to get the property with component " + componentName.Value);
                return TaskStatus.Failure;
            }
