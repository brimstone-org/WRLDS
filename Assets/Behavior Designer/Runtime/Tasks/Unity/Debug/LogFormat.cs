...
{
    [TaskDescription("LogFormat is analgous to //global::Logger.LogFormat().\n" +
    ...
    public class LogFormat : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (logError.Value) {
                //global::Logger.LogErrorFormat(textFormat.Value, paramsArray);
            } else {
                //global::Logger.LogFormat(textFormat.Value, paramsArray);
            }
